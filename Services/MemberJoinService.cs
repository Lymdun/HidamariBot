...
public class MemberJoinService : DiscordBotService {
    ...
    const string QUESTIONNAIRE = "https://discord.com/channels/450280270654865439/1203052960712622110/1203439457248743425";
    ...
    async Task SendJoinNotificationAsync (Snowflake guildId, IMember newMember) {
        try {
            LocalMessage message = new LocalMessage()
                .WithContent($"{Mention.User(newMember.Id)} Bienvenue sur le reversed, pour passer la frontière il faut remplir le questionnaire {QUESTIONNAIRE} 📋");
